...
<template>
    <div class="grid min-h-svh md:grid-cols-[45%_55%]">
        ...
        >
            <Link :href="home()" class="flex items-center gap-2 text-lg font-semibold">
            ...
            <div class="flex flex-1 items-center">
                <div class="max-w-md">
                    ...
                    <div class="mt-6 flex items-center gap-3">
                        ...
                        <div>
                            <p class="text-sm font-medium">Maya Rodriguez</p>
                            <p class="text-sm text-white/70">CTO, Meridian Labs</p>
                        </div>
                    </div>
                </div>
            </div>
